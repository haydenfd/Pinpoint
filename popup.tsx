      ...
      <div className="p-5 flex flex-col items-center gap-4">
        ...
        <div className="flex items-center gap-2 text-[10px] text-neutral-500 uppercase tracking-widest font-bold">
          ...
          <div className="flex gap-1.5 items-center">
            {isMac ? (
              <>
                <kbd className="px-1.5 py-0.5 rounded border border-neutral-700 bg-neutral-900 text-xs font-sans">
                  ⌘
                </kbd>
                <kbd className="px-1.5 py-0.5 rounded border border-neutral-700 bg-neutral-900 text-xs font-sans">
                  ⇧
              ...
              <>
                <kbd className="px-1.5 py-0.5 rounded border border-neutral-700 bg-neutral-900 text-[10px]">
                  Ctrl
                </kbd>
                <kbd className="px-1.5 py-0.5 rounded border border-neutral-700 bg-neutral-900 text-[10px]">
                  Shift
